...
import { ScrollView, Alert, StyleSheet,ToastAndroid, Text, TextInput, Pressable, Button, View, Image, TouchableOpacity, ActivityIndicator, Modal } from 'react-native'
...
export default function Firebrigade({ navigation, route }) {
    ...
    return (
        <View style={[styles.h100, styles.bgWhite,]}>
            ...
            <View style={[styles.bgWhite, styles.w100, styles.p3,]}>
                ...
                <TouchableOpacity onPress={() => setModalVisible(true,setRequestType("Cylinde Blast"))} style={[styles.bgRed, styles.w100, styles.p1, styles.flexCenter, styles.mb2, styles.px3, { borderRadius: 50 }]}>
                    <Text style={[styles.textLight, styles.fs5]}>{isloading ? <ActivityIndicator color={styles._white} size={"small"} /> : "Cylinder Blast"}</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setModalVisible(true,setRequestType("Short Circuit"))} style={[styles.bgRed, styles.w100, styles.p1, styles.flexCenter, styles.mb2, styles.px3, { borderRadius: 50 }]}>
                    <Text style={[styles.textLight, styles.fs5]}>{isloading ? <ActivityIndicator color={styles._white} size={"small"} /> : "Short Circuit"}</Text>
                </TouchableOpacity>
            </View>
